...
**Answer** The code is adding a column named percent_election_day that shows the answer when the election day column is divided by the votes column.
...
**Answer** it sorts by the amount of people that voted on election day for each canidate.
...
**Answer** Maybe, it depends on what the data says
...
**Answer** str_to_lower, lowercases all letters
...
**Answer** It's showing us thing ssorted by month
