...
https://datawrapper.dwcdn.net/IBSLv/1/
...
**Task** Look for "Hide regions without data" under Appearance, and click the slider icon to enable that feature. You should see a map zoomed into Maryland with some counties in various colors. **Answer** Describe the changes from the previous map It's much more zoomed in and there are no more blank areas.
...
https://datawrapper.dwcdn.net/BM9D7/1/
