...
**Task** Run the following code and describe the dataframe it outputs. **Answer** It shows the dates, titles, urls, and texts of documents
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** It takes out all the duplicates
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** It gives a list of all of the words
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** Words like the are the most commonly seen
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** All the words like the that aren't very descriptive are reomved
...
**Task** Run the following code and describe the results. **Answer** There's more mentions of health related things in 2022 and more mentions of the military in 2024
...
**Task** Run the following code and describe the results. **Answer** Names of places are mentioned more, but health is still a prominent issue
...
**Task** Run the following code and describe the results. **Answer** It's actually kinda similiar to 2022
...
**Task** Run the following code and describe the differences between the two results. Which one might be more useful for the press release data? **Answer** I =t shows a list of words. Honestly, there aren't many differences, the only thing is that the first one shows a past tense. It seems as if stemming takes unique words which might be more useful
...
**Task** Run the following code and describe the differences between the two results. Which one is more useful? **Answer** They're really not that different, there's less military in the second df
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** I think critical is an interesting one to be negative and rail being negative is surprising
