...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** There's some ordinary things like county, precincts, and schools, but there's also columns with shape in them. 
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It contains some numeric information andids then it contains some mutlipolygon descriptions and numbers.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It looks like a rorschach test, but I assume it is PG county's shape.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It tells me something about the library
...
**Task** Run the following code. Describe the output in the space below. **Answer** It looks like a bunch of nonsense
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a dataframe with only MD counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's Maryland
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's PG county again
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a dataframe with ballot data
...
**Task** Run the following code. Describe the output in the space below. **Answer** It joined the dataframes
...
**Task** Run the following code. Describe the output in the space below. **Answer** PG county is labeled with a key
...
**Task** Run the following code. Describe the output in the space below. **Answer** A dataframe with coter numbers
...
**Task** Run the following code. Describe the output in the space below. **Answer** A dataframe with population
...
**Task** Run the following code. Describe the output in the space below. **Answer** a dataframe with census inforamtion for population
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's both dataframes
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's a dataframe with both population and geometry
...
**Task** Run the following code. Describe the output in the space below. **Answer** It joined the two dataframes
...
**Task** Run the following code. Describe the output in the space below. **Answer** Something
...
**Task** Run the following code. Describe the output in the space below. **Answer** It created a map of maryland
...
**Task** Run the following code. Describe the output in the space below. **Answer** It filled in the amount of voters
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** No idea
...
**Task** Run the following code. Describe the output in the space below. **Answer** Creates a new column for una voters
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** It's a map of una voters. The most una voters are in central maryland
