...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** Yes they do but some of them have them organized differently
...
**Task** Load the Maryland 2020 county population data **Answer** Ok
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer** The ratio of asians are a lot smaller and they seem to mostly live in Howard and Montgomery compared to PG and Baltimore
