...
```{r echo=FALSE}
census_api_key("bdb93e9360331048d57f80b2783f26f89639875e", install=TRUE)
```
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** What's the demographic make up? What kind of employment do hey have?
