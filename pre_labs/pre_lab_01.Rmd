...
**Answer** I think this code is counting the number of contributions during certain dates compared to just taking the top six rows.
...
**Answer** It seems that the list is now ordered from most to least
...
**Answer** There are names attached to each contribution
...
**Answer** They sorted it from most to leadt
...
**Answer** It sorts by count contributed and now has a mean and a median column. The top result from Maryland is from Hogan for Maryland inc.
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** It sorts by the cities total contribution
...
You can just load all the libraries with tidyverse