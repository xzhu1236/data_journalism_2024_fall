...
**Answer** The first part is creating a row where the difference in unaffiliated voters is shown. The second block is just arranging by most to least and taking the top 10 and selecting for specific columns.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It's a bar graph of the counties as its x-axis and number of unaffiliated voters as its y
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It's ordered from least to greatest
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The x and y axis have flipped
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background is all white now
...
**Task** Run the following code. **Answer** ok
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The background the font size and maybe the font has changed
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There's a caption and the title and labels for the x and y axis is different
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It's a count of the number of contributions by date
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** it created a line graph that has the total contributions on the y axis and the date on the x
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There's now marks on the graph
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The labels for the x axis are now angled
