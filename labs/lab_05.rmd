...
```{r}
july_august_harris |> left_join(new_voters, join_by( first_name==FirstName, last_name==LastName, address_one==Address))
```
...
A2. There are 353 unique donors the highest donors are: Emily Duncan, Dennis Meng, and Geoffrey Kinsey. The most donations were given by Brittany Musolino, Eric Snipe, and Sophia Hoffer-Perkins.
...
A3. Harris has mostly Dem donors and a slim amount of Rep donors along with others. There is a slim majority of female voters donating to Harris. Harris has gotten 41 donations from non-Dems.
